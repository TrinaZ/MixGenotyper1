...
for q in range(0,10):
    ...
    class Variation:
        ...
        def SetFeature(self, AbnormalRead, NormalRead, IncompleteRead, FullyRead, SingleRead, SplitRead, FsamRead,
            ...
            self.Result = Result
    f = open('F:/importantfilecopy/tandomrepeat/2019.121test/sam20/20'+str(q)+'.sam', 'r')
    line = f.readline()
    line = f.readline()
    for line in f:
    ...
    VariationList = []
    type = []
    f2 = open('F:/importantfilecopy/tandomrepeat/2019.121test/v'+str(q)+'.txt', 'r')
    for line1 in f2:
    ...
    for (elem_start,elem_end) in zip(list(start),list(end)):
        ...
        spread1left = []
        spread2left = []
        f = open('F:/importantfilecopy/tandomrepeat/2019.121test/sam20/20'+str(q)+'.f.sam', 'r')
        line = f.readline()
        line = f.readline()
        # line = f.readline()
        for line in f:
    ...
    fout = open("F:/importantfilecopy/tandomrepeat/2019.121test/fotwresults", "a")
